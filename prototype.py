...
while j < 999:
    # find_if_login = list(pyautogui.locateAllOnScreen('images/'+ config['default']['image'] +'/btn-login.png', confidence=0.8))
    # find_if_login2 = pyautogui.locateAllOnScreen('images/'+ config['default']['image'] +'/btn-login.png', confidence=0.8)
    # print(find_if_login2)
    for m in pyautogui.locateAllOnScreen('images/'+ config['default']['image'] +'/btn-login.png', confidence=0.8):
        print(m)
    # print(find_if_login)
